/**
 * Routes API pour le module Coordination.
 */
...
const { filterPlanifiableTpis } = require('../services/coordinationTpiVisibility')
const {
  getPlanningConfig,
...
/**
 * POST /api/coordination/auth/magic-link
...
/**
 * GET /api/coordination/auth/verify
...
/**
 * POST /api/coordination/persons/import
...
/**
 * PUT /api/coordination/persons/:id
...
/**
 * POST /api/coordination/persons/merge
...
/**
 * DELETE /api/coordination/persons/:id
...
/**
 * PUT /api/coordination/persons/:id/availability
...
/**
 * POST /api/coordination/slots/generate
...
/**
 * GET /api/coordination/slots/:year
...
/**
 * GET /api/coordination/slots/:year/calendar
...
// ============================================
// ROUTES TPI COORDINATION
// ============================================

/**
 * GET /api/coordination/tpi/:year
...
/**
 * GET /api/coordination/tpi/:year/:id
 * Détails d'un TPI
 */
...
/**
 * POST /api/coordination/tpi/:id/propose-slots
...
/**
 * POST /api/coordination/tpi/:id/force-slot
...
/**
 * POST /api/coordination/tpi/:id/move-to-slot/:slotId/simulate
...
/**
 * POST /api/coordination/tpi/:id/move-to-slot/:slotId
...
/**
 * POST /api/coordination/tpi/:id/resolution-proposals
...
/**
 * GET /api/coordination/votes/pending
...
/**
 * POST /api/coordination/votes/respond/:tpiId
...
/**
 * POST /api/coordination/votes/bulk
...
/**
 * POST /api/coordination/votes/:id/preferred-soutenance-choice
...
/**
 * POST /api/coordination/votes/:id
 * Soumet un vote
 */
...
/**
 * GET /api/coordination/availability/:year/:tpiId
...
/**
 * POST /api/coordination/assign/:slotId
...
/**
 * POST /api/coordination/tpi/:id/resend-votes
