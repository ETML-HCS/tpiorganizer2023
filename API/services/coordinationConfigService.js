...
function normalizeAccessLinkSettings(value = {}, fallback = DEFAULT_ACCESS_LINK_SETTINGS) {
  ...
  return {
    ...
    workflowFreeModeEnabled: normalizeBooleanOption(
      source.workflowFreeModeEnabled ?? source.freeWorkflowModeEnabled ?? source.ignoreWorkflowStateForLinks,
      fallbackSource.workflowFreeModeEnabled ?? DEFAULT_ACCESS_LINK_SETTINGS.workflowFreeModeEnabled
    )
  }
}
