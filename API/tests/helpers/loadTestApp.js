...
function loadTestApp(env = {}) {
  ...
  const modulesToClear = [
    ...
    path.resolve(__dirname, '../../routes/gestionTpiRoutes.js'),
    ...
    path.resolve(__dirname, '../../modules/gestionTpi/constants.js'),
    path.resolve(__dirname, '../../modules/gestionTpi/normalization.js'),
    path.resolve(__dirname, '../../modules/gestionTpi/rules.js'),
    path.resolve(__dirname, '../../modules/gestionTpi/catalogService.js'),
    path.resolve(__dirname, '../../services/coordinationTpiVisibility.js'),
    path.resolve(__dirname, '../../services/tpiPlanningVisibility.js'),
    path.resolve(__dirname, '../../services/workflowService.js'),
    path.resolve(__dirname, '../../services/coordinationAutomationService.js'),
    path.resolve(__dirname, '../../services/planningAutomationService.js'),
    path.resolve(__dirname, '../../services/coordinationValidationService.js'),
    path.resolve(__dirname, '../../services/planningValidationService.js'),
    path.resolve(__dirname, '../../services/coordinationRuleUtils.js'),
    path.resolve(__dirname, '../../services/planningRuleUtils.js'),
    path.resolve(__dirname, '../../services/coordinationTpiResponseService.js'),
    path.resolve(__dirname, '../../services/planningTpiResponseService.js'),
    path.resolve(__dirname, '../../services/votingCampaignService.js'),
    path.resolve(__dirname, '../../modules/accessLinks/constants.js'),
    path.resolve(__dirname, '../../modules/accessLinks/tokenService.js'),
    path.resolve(__dirname, '../../modules/accessLinks/previewService.js'),
    path.resolve(__dirname, '../../services/tpiCatalogService.js'),
    path.resolve(__dirname, '../../services/coordinationConfigService.js'),
    path.resolve(__dirname, '../../services/planningConfigService.js'),
    path.resolve(__dirname, '../../services/coordinationCatalogService.js'),
    ...
    path.resolve(__dirname, '../../routes/coordinationRoutes.js'),
